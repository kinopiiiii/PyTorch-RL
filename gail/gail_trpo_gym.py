...
def main_loop():
    ...
    for i_iter in range(args.max_iter_num):
        ...
        if i_iter % args.log_interval == 0:
            ...
            print('{} {} samp:{:.4f}  update:{:.4f}  ex_R_avg:{:.2f}  Score:{:.2f}  pScore:{:.4f}  Rate:{:.2f}'.format(i_iter, args.env_name, log['sample_time'], t1 - t0, log['avg_c_reward'],
                                                                                                                       log['avg_reward'], log['avg_path_reward'], log['success_rate']))
